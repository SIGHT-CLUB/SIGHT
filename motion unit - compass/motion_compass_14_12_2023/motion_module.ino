...
const int MOTOR_RATED_VOLTAGE = 5;  // The voltage the motor is designed to operate at [volt]
...
unsigned int PWM_UPDATE_PERIOD = 25;  // The period for updating the PWM value [milliseconds]
