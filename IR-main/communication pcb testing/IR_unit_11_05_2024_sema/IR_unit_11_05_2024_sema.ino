...
void listen_for_ack(){
  ...
  mode_of_operation = 2; //if no ack is received, change to listen for ping mode
}

void listen_for_ping(){
  ...
  Serial.println("Rotating and Listening for Ping");
  ...
  while (millis() - listen_ping_start_time < 40) {
  ...
  if (!is_received){mode_of_operation = 0;} //if no ping is received, change to ping mode
}

void listen_for_ping_after_capture(){
